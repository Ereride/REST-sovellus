...
public class kysymystenhallinta {
    ...
    @GetMapping("/")
    public String index () {
        return "Tervetuloa visailupeliin! Voit pelata Postmanilla GET-pyynnöllä kahdella eri tapaa. 1. GET tapa /kysymys?id=Nro: Nro kohdalle laitetaan numero 1-30, jolloin saadaan sen ID:n kysymys. 2. GET tapa /kysymys/random: Palauttaa satunnaisen kysymyksen. Vastauksen antaminen tapahtuu POST-pyynnöllä antamalla vastaus ID:n perusteella, postmanissa Body/raw ja valitaan JSON. Vastauksessa annetaan id: nro, vastaus: kirjoita vastaus tähän. Sen jälkeen kerrotaan, onko vastaus oikein vai väärin.";
    }
